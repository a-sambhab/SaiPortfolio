...
const greeting = {
  username: "Sai Sambhab Chaini",
  title: "Hi all, I'm Sai Sambhab Chaini",
  subTitle: emoji(
  ...
  resumeLink:
    "https://drive.google.com/file/d/1Ds9ws9fjdiaEEoxwzypPCvFV39CuXXh3/view?usp=sharing", // Set to empty to hide the button
...
const socialMediaLinks = {
  ...
  gmail: "saisambhab.chaini@gmail.com",
...
const skillsSection = {
  title: "What I do",
  subTitle: "FULL STACK DEVELOPER WHO LOVES TO PUSH THE BOUNDARIES OF WHAT'S POSSIBLE",
  skills: [
    emoji(
      "⚡ Craft engaging and intuitive front-end and user interfaces for your web applications."
    ),
    emoji("⚡ Create scalable backend applications using Node.js and Django."),
    emoji(
